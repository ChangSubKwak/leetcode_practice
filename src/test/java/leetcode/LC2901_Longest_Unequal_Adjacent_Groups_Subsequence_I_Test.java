...
class LC2901_Longest_Unequal_Adjacent_Groups_Subsequence_I_Test {
    @Test
    void test() {
        LC2901_Longest_Unequal_Adjacent_Groups_Subsequence_I test = new LC2901_Longest_Unequal_Adjacent_Groups_Subsequence_I();
