...
public class LC0127_WordLadder {
	...
	public static void main(String[] args) {
		LC0127_WordLadder t = new LC0127_WordLadder();
		System.out.println(t.ladderLength("hit", "cog", Arrays.asList("hot","dot","dog","lot","log","cog")));
		System.out.println(t.ladderLength("hit", "cog", Arrays.asList("hot","dot","dog","lot","log")));
	}
}
