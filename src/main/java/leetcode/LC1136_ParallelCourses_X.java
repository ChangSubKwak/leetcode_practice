...
public class LC1136_ParallelCourses_X {
	...
	public int minimumSemesters(int n, int[][] relations) {
		...
		for(int i = 1; i <= n; i++) {
			...
			//System.out.println(depth + " : " + Arrays.toString(inDegree) + " : " + q);
